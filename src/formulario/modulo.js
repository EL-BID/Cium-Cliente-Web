(function () {
	 ...
	 */
	var capturaIndicadorModule = angular.module('CapturaIndicadorModule', ['ngMaterial', 'ngRoute', 'ngStorage', 'ngCookies', 'ngMessages', 'pascalprecht.translate', 'http-auth-interceptor'])
		.controller('CapturaIndicadorCtrl', function ($rootScope, $translate, $window, $http, $scope, $mdDialog, CrudDataApi, $mdSidenav, $location, $mdBottomSheet, UsuarioData, Auth, Menu, errorFlash, flash, $mdToast, URLS, listaOpcion) {
			...
			*/
			$scope.modificar = function (id) {
				...
				if (!angular.isUndefined($scope.color.green)) {
					if ($scope.color.red != '' || $scope.color.green != '' || $scope.color.blue != '') {
						json.color = 'rgb(' + $scope.color.red + ',' + $scope.color.green + ',' + $scope.color.blue + ')';
					} else {
			...
			*/
			...
			$scope.cambiar_anio_nuevo = function() {
				$scope.dato = [];
				$scope.anio_dato = false;
				CrudDataApi.ver("/anio-captura", $scope.anio, function (data) {
					if (data.status == '407')
						$window.location = "acceso";
	...
	capturaIndicadorModule.config(['$mdThemingProvider', '$mdIconProvider', '$routeProvider', '$httpProvider', '$translateProvider', '$mdThemingProvider', function ($mdThemingProvider, $mdIconProvider, $routeProvider, $httpProvider, $translateProvider, $mdThemingProvider) {

		$routeProvider


			.when('/formulario-dashboard', { templateUrl: 'src/formulario/formulario-dashboard/views/lista.html', controller: 'CapturaIndicadorCtrl' })

			.when('/formulario-indicador', { templateUrl: 'src/formulario/formulario-indicador/views/lista.html', controller: 'CapturaIndicadorCtrl' })
			.when('/formulario-indicador/nuevo', { templateUrl: 'src/formulario/formulario-indicador/views/nuevo.html', controller: 'CapturaIndicadorCtrl' })
			.when('/formulario-indicador/modificar', { templateUrl: 'src/formulario/formulario-indicador/views/modificar.html', controller: 'CapturaIndicadorCtrl' })
			.when('/formulario-indicador/ver', { templateUrl: 'src/formulario/formulario-indicador/views/ver.html', controller: 'CapturaIndicadorCtrl' })

			.when('/formulario-captura', { templateUrl: 'src/formulario/formulario-captura/views/lista.html', controller: 'CapturaIndicadorCtrl' })
			.when('/formulario-captura/nuevo', { templateUrl: 'src/formulario/formulario-captura/views/nuevo.html', controller: 'CapturaIndicadorCtrl' })
			.when('/formulario-captura/modificar', { templateUrl: 'src/formulario/formulario-captura/views/modificar.html', controller: 'CapturaIndicadorCtrl' })
			.when('/formulario-captura/ver', { templateUrl: 'src/formulario/formulario-captura/views/ver.html', controller: 'CapturaIndicadorCtrl' })
