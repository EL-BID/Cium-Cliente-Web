(function () {
	...
	*/
	...
	'use strict';
	angular.module('FormularioModule')
		.controller('FormCtrl', function ($rootScope, $translate, $window, $http, $scope, $mdDialog, CrudDataApi, $mdSidenav, $location, $mdBottomSheet, UsuarioData, Auth, Menu, errorFlash, flash, $mdToast, URLS, listaOpcion) {
